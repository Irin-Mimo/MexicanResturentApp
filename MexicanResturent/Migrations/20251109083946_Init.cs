    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Delicious beef taco with fresh ingredients", "Beef Taco", 3.99m, 100 },
                    { 2, 2, "Tasty chicken burrito with rice and beans", "Chicken Burrito", 5.99m, 80 },
                    { 3, 3, "Crispy fish quesadilla with melted cheese", "Fish Quesadilla", 4.99m, 50 }
                });
